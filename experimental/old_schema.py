...
from debezium_connectors.models import DebeziumConnectorConfig, DebeziumConnector
...
class UpdateDebeziumConnector(graphene.Mutation):
    ...
    def mutate(self, info, **kwargs):
        ...
        debezium_connector.save()
        return UpdateDebeziumConnector(debezium_connector=debezium_connector)
...
class CreateDebeziumConnectorConfig(graphene.Mutation):
    ...
    def mutate(self, info, **kwargs):
        ...
        debezium_connector_config = debezium_connectors.DebeziumConnectorConfig()
